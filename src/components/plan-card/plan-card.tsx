...
const PlanCard = ({product}: PlanCardProps) => {
    ...
    const onSubmitSubscribe = async (priceId: string) => {
      setIsLoading(true)
    ...
    return (
        ...
        <button 
          onClick={() => onSubmitSubscribe(product.default_price.id)} 
          className="mt-4 w-full rounded-md py-3 cursor-pointer font-semibold bg-emerald-500 transform hover:bg-emerald-400 transition duration-500" disabled={isLoading}>
